...
using Elfland.WebAPI.Attributes;
using Microsoft.Extensions.DependencyInjection;

namespace Elfland.WebAPI.Extensions;
...
public static class AutomaticDependencyInjectionExtensions
{
    ...
    private static void RegisterLifetimesByAttribute(
        ...
        AppDomain.CurrentDomain
            ...
            .Where(
                implementationType =>
                    implementationType.GetCustomAttribute<AutomaticDependencyInjectionAttribute>()?.Lifetime
                        == serviceLifetime
